...
assert.ok(grindSource.includes('prompt_search_recipe'));
assert.ok(grindSource.includes('prompt_search_cursor'));
assert.ok(grindSource.includes('prompt_lattice_size'));
assert.ok(grindSource.includes('prompted direction'));
assert.ok(grindSource.includes('Generation-only search instruction'));
assert.ok(grindSource.includes('measured radius, direction signature, and angular gap'));
