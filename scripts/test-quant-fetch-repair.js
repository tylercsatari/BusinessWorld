...
includes(index, 'storyboard-workbench.js?v=6', 'the advanced storyboard workbench bundle must load before Shorts');
...
includes(index, 'storyboard-workbench.css?v=5', 'the advanced storyboard workbench styles must be cache-busted');
