...
includes(index, 'jarvis-retention.js?v=experiment-lab-surface-v2', 'Shorts bundle cache key must be bumped');
includes(index, 'storyboard-workbench.js?v=3', 'the advanced storyboard workbench bundle must load before Shorts');
