...
includes(index, 'jarvis-retention.js?v=experiment-lab-surface-v4', 'Shorts bundle cache key must be bumped');
...
includes(index, 'experimentlab.css?v=8', 'Experiment Lab score presentation styles must be cache-busted');
