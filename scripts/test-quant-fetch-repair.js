...
includes(index, 'jarvis-retention.js?v=experiment-lab-surface-v3', 'Shorts bundle cache key must be bumped');
includes(index, 'storyboard-workbench.js?v=4', 'the advanced storyboard workbench bundle must load before Shorts');
includes(index, 'experimentlab-ui.js?v=6', 'Experiment Lab score handoff bundle must be cache-busted');
includes(index, 'experimentlab.css?v=7', 'Experiment Lab score presentation styles must be cache-busted');
includes(index, 'storyboard-workbench.css?v=3', 'the advanced storyboard workbench styles must be cache-busted');
