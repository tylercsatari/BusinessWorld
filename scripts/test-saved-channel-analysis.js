...
for (const marker of ['data-savedbank', 'data-savedchanneladd', 'data-savedchannelvideo', 'Prediction analysis', 'Relationship atlas (21)', 'Blind validation', 'data-savedvalidation-canonical', 'All 103 coordinates × all 13 observed outcomes', '103 ledger columns do not mean 103 independent embeddings', 'data-savedvalidationscope', 'data-savedvalidationfeature', 'data-savedvalidationcell', 'data-savedvalidation-video-table', 'Held-out predicted ${outcome.label} vs observed ${outcome.label}', 'data-savedvalidationplotmode', 'data-savedvisualkeep-study', 'Best tested visual-only keep-rate predictor', 'other videos from the same creator may remain', 'This is not a forward-time test', 'data-savedchannelrelationshipatlas', 'data-savedchannelrelationshipplot', 'drawSavedChannelRelationshipPlots', 'Which single indicators predict log views?', 'Execution risk · can an embedding score justify making the video?', 'data-savedchannelrisktarget', 'data-savedchannelriskcutoff', 'data-savedchannelmatchedquestions', 'data-savedchannelriskprojection', 'data-savedchannelriskevidence', 'data-savedchannelriskinspector', 'data-savedchannelriskdrill', 'data-savedchannelriskthresholdtable', 'data-savedchannelriskcurve', 'data-savedchannelriskcalibration', 'the exact videos behind the number', 'data-savedchannelriskglossary', 'data-savedchannelanalysisartifact', 'conservative EV', 'data-savedchannelmatrix', 'Closest high → high trajectory', 'data-savedchannelindicatorplayground', 'data-savedchannelrelationships', 'data-savedchannelprofileatlas', 'data-savedchannelresiduals', 'savedChannelBinaryCurve', 'continue ${unfinished} unfinished', "st.savedChannelSort = 'feature'", 'wireSavedChannelImages', 'record.montageDataUrl = `/api/raw/saved-channel/']) {
    assert(ui.includes(marker), `Shorts Experiment UI is missing ${marker}`);
}
for (const route of ['/api/raw/saved-channels', '/api/raw/saved-channel', '/api/raw/saved-channel-validation', '/api/raw/hook-enrich', 'savedChannelValidation.buildValidation', 'savedChannelAnalysis.analyzeChannel', 'serveR2ObjectForRequest(req, res, key']) {
...
assert(server.includes("sourceBuffers.set('local:saved-channel-feature-contract.json'"), 'blind-validation cache fingerprint must include the 21-feature contract');
