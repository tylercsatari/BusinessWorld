// swipe-scraper-long.js — LONG-FORM sibling of swipe-scraper.js. This is an adapted copy so
// the Shorts flow (swipe-scraper.js) stays 100% untouched. The long-form orchestrator
// (scrape-channels-long.js) only needs SESSION_DIR from here so it shares the SAME logged-in
// Chrome profile (yt-chrome-profile) as the Shorts flow — one login, both flows.
//
// The swipe-extraction helpers (scrapeOneVideo / extractSwipeFromDOM / findSwipeInText) are
// retained verbatim for parity, but long-form videos have no "Swiped away" metric — the
// long-form orchestrator does NOT call scrapeOneVideo; it uses its own parseReach /
// parseRetention (CTR / impressions / absolute+relative retention) instead.
//
