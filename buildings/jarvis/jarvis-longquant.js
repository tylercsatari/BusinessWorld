...
const JarvisLongQuant = (function () {
    ...
    let root = null, DATA = null, S = null, S_MAIN = null, N = null, CR = null, INT = null, CF = null, RTGF = null, RTGA = null, RTGE = null, RTGH = null, GRAT = null, GRAT_COMPONENTS = null, GRAT_MATRICES = null, LIB = null, LIBV = null, SHORTSV = null, RAW = {}, FUSION = null, NOV = null, NCEXP = null, NQ = null, NQF = null, CHANS = null, CHDECON = null, TRIBE = null, err = null;
    ...
    function gratV2Nav() {
        const views = [['overview', 'Overview'], ['components', 'Components + context'], ['geometry', 'Retention geometry'], ['matrices', 'All relationships'], ['experiments', 'Experiment registry'], ['pairs', 'Same-idea differences'], ['validation', 'Confounds + validation']];
    ...
    function renderGratificationV2(R) {
        ...
        const content = st.gratV2View === 'components' ? gratV2Components(R) : st.gratV2View === 'geometry' ? gratV2Geometry(R) : st.gratV2View === 'matrices' ? gratV2Matrices(R) : st.gratV2View === 'experiments' ? gratV2Experiments(R) : st.gratV2View === 'pairs' ? gratV2Pairs(R) : st.gratV2View === 'validation' ? gratV2Validation(R) : gratV2Overview(R);
    ...
    function onClick(e) {
        ...
        const g2v = e.target.closest('[data-gratv2view]'); if (g2v) { st.gratV2View = g2v.getAttribute('data-gratv2view'); rtgUpdateGratification(); return; }
