...
const STATIC_VARIABLES = {
    ...
    // LLM-scored variables removed (no prompt provenance):
    // z_score, z_type, vz_score, vz_type, novelty, cognitive_load, net_novelty
    // These can be re-added in the future with full prompt documentation.
