...
START_ROUND=${START_ROUND:-13} START_MODEL=${START_MODEL:-/home/ubuntu/thumbrl/models/thumbmerged_b10} \
UPDATER=bond BOND_EPOCHS=2 BOND_MINPCT=0.78 NOTHINK=1 MAXNEW=350 TITLE_SHARD=0/2 G=6 PROXY_G=0 TBATCH=26 ROUND_BUDGET=2400 \
