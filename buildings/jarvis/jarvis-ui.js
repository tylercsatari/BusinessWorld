...
const JarvisUI = (() => {
    ...
    // ── Hardcoded Data ──
    const EXPERIMENTS = [
        { id: 'exp11', name: 'Full Distribution: Keep Rate by View Tier', r: null, n: 372, type: 'quantified', status: 'complete', source: 'Tyler Channel', finding: 'Keep rate (100-swipeAway): Sub-1M=92.3%, 1-5M=93.1%, 5-50M=94.8%, 100M+=56.5%. The 100M+ number is low because the indestructible armour video (285M views) was algorithmically blasted to 80M+ impressions of non-core audiences. This confirms Tyler is right: keep rate drops when algorithm force-pushes to broad audiences, not because the hook is weak.' },
        { id: 'exp12', name: 'Retention Distribution: 85-90% is the Sweet Spot', r: null, n: 372, type: 'quantified', status: 'complete', source: 'Tyler Channel', finding: 'Bucket analysis: 85-90% retention → avg 10.6M views (n=103, max=285M). 90-95% → avg 9.0M. 80-85% → avg 5.4M. 95-100% → avg 11.9M (but only n=12). The 85-90% bucket is the largest high-performing cluster. Getting from 80% to 85%+ retention is the clearest lever for doubling views.' },
        { id: 'exp13', name: 'Gold Standard Video: Fire Proof Shield', r: null, n: 1, type: 'quantified', status: 'complete', source: 'Tyler Channel', finding: '62M views | 99.9% keep rate | 86.1% retention | 1.999 shares/1k views (highest in dataset). This is the ideal pattern: excellent hook (near-perfect keep), strong retention, AND high shareability. Contrast with Indestructible Armour (285M views, 56.5% keep, 0.048 shares/1k) — pure algorithm push, not hook-driven.' },
    ...
    const INSIGHTS = [
        '<strong>Retention 85-90% is the performance sweet spot</strong> — the largest cluster of high-view videos (n=103, avg 10.6M). Getting from 80% to 85%+ is the clearest, most actionable lever for doubling views.',
        '<strong>Gold standard is Fire Proof Shield</strong> — 99.9% keep + 86% retention + 2.0 shares/1k = 62M views. This is the ideal combination. Indestructible Armour hit 285M via pure algorithm push with 56% keep and 0.05 shares/1k.',
        '<strong>Keep rate at 100M+ looks broken</strong> — algorithmic blast reaches non-core audiences, tanking lifetime swipe-away. Early keep rate (first 1M impressions) is the real signal, not lifetime swipe-away.',
